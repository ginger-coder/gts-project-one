      ...
      return (
        <Accordion.Panel header={el.title} key={el.id}>
            <List className="my-list">
              <List.Item arrow="horizontal" onClick={() => linkToPath(`/oadmin/health/detail/${el.id}`)} >查看</List.Item>
              <List.Item arrow="horizontal" onClick={() => linkToPath(`/oadmin/health/edit/${el.id}`)}>编辑</List.Item>
